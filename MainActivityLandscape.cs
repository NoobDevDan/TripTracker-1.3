...
namespace TripTracker
{
    ...
    [Activity(Icon = "@drawable/icon", ScreenOrientation = ScreenOrientation.Landscape, Theme = "@android:style/Theme.NoTitleBar")]  
    public class MainActivityLandscape : Activity, IOnMapReadyCallback, ILocationListener, ISnapshotReadyCallback
    {
